...
export const mockExercises: Exercise[] = [
  { id: 1,  name: "Bench Press",           description: "Flat barbell press",                   difficulty: "Intermediate", muscles: [m("chest"), m("triceps")] },
  ...
  { id: 10, name: "Plank",                 description: "Core stability",                        difficulty: "Easy",         muscles: [m("abs")] },
  { id: 11, name: "Calf Raise",            description: "Standing calf work",                    difficulty: "Easy",         muscles: [m("calves")] },
  { id: 12, name: "Romanian Deadlift",     description: "Hamstring isolation",                   difficulty: "Intermediate", muscles: [m("hamstrings"), m("glutes")] },
  { id: 13, name: "Neck Extension",        description: "Posterior neck strengthening",          difficulty: "Easy",         muscles: [m("neck")] },
  { id: 14, name: "Neck Flexion",          description: "Anterior neck isometric hold",          difficulty: "Easy",         muscles: [m("neck")] },
  { id: 15, name: "Lateral Neck Stretch",  description: "Side neck mobility and light work",     difficulty: "Easy",         muscles: [m("neck")] },
];
